...
class Thermohaline_dataset(Dataset):
    def __init__(self, data_root, data_name, training_time, step,
        ...
        dataset_input = xr.open_dataset(data_root + r'/map_processed_input_2004-2022.nc')
        dataset_label = xr.open_dataset(data_root + r'/processed_label_2004-2022.nc')
        ...
        var_list1 = ['east_wind','north_wind','adt', 'sla', 'east_stress','north_stress',
                     'ild_arr','mld_arr', 'ssd','sss','nasa_sst']
...
#               data_root,
#               num_workers,
#               data_name='thermohaline',
#               train_time=[0, 192],
#               val_time=[192, 204],
#               test_time=[192, 204],
#               step=1,
#               **kwargs):
#     thermohaline_dataroot = os.path.join(data_root, 'thermohaline')
#
#     train_set = Thermohaline_dataset(data_root=thermohaline_dataroot,
#                                      data_name=data_name,
#                                      training_time=train_time,
#                                      step=step)
#     validation_set = Thermohaline_dataset(thermohaline_dataroot,
#                                           data_name,
#                                           val_time,
#                                           step)
#     test_set = Thermohaline_dataset(thermohaline_dataroot,
#                                     data_name,
#                                     test_time,
#                                     step)
#
...
#                                                   num_workers=num_workers)
#     import numpy as np
#     temp_map=np.load(data_root+r'/thermohaline/map_to_temp_0.npy')
#     salt_map=np.load(data_root+r'/thermohaline/map_to_salt_0.npy')
#     # dataset_map_media=np.concatenate((temp_map,salt_map),axis=1)[192,:,None,:,:]
#     dataset_map_media = temp_map[192, :, None, :, :]
#     dataset_map=dataset_map_media[None,:,:,:,:]
#     return dataloader_train, dataloader_vali, dataloader_test,dataset_map
