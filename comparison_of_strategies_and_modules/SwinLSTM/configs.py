...
def get_args():
    ...
    parser.add_argument('--num_frames_output', default=45, type=int, help='Output sequence length')
    parser.add_argument('--image_size', default=(160,360), type=int, help='Original resolution')
    parser.add_argument('--input_size', default=(80, 180), help='Input resolution')
    parser.add_argument('--step_length', default=0.1, type=float)
    parser.add_argument('--num_objects', default=[2], type=int)
    parser.add_argument('--train_samples', default=[0, 216], type=int, help='Number of samples in training set')
    parser.add_argument('--valid_samples', default=[216, 228], type=int, help='Number of samples in validation set')
    parser.add_argument('--train_data_dir', default='./data/map_processed_input_2004-2022.nc')
    parser.add_argument('--test_data_dir', default='./data/processed_label_2004-2022.nc')
    ...
    parser.add_argument('--input_img_size', default=(160,360), type=int, help='Input image size')
