...
def setup():
    ...
    model = SwinLSTM(in_shape=(10, 1, 180, 360), hid_S=64, hid_T=256, N_S=2, mlp_ratio=4, drop=0,
                               drop_path=0.1, spatio_kernel_dec=(3, 3), spatio_kernel_enc=(3, 3),
                               Depth_out1=len(depths1),Depth_out2=len(depths2),Depth_out3=len(depths3)).to(device)
...
def main():
    set_seed(42)
    model_dir, log_dir, save_dir,plot_dir,best_checkpoint,interval_checkpoint=make_dir('./exp_3_4_5_100_300_backward_3')
