...
from model_vit import Thermohaline_Model
...
def setup():
    ...
    valid_loader = DataLoader(valid_dataset, batch_size=1,
                             num_workers=1, shuffle=False, pin_memory=True, drop_last=True)
...
def main():
    set_seed(42)
    model_dir, log_dir, save_dir,plot_dir,best_checkpoint,interval_checkpoint=make_dir('./tri-stage-vit-temp-v2')
