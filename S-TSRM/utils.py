...
def make_dir(res_dir):
    model_dir = os.path.join(res_dir, 'model')
    check_dir(model_dir)
    log_dir = os.path.join(res_dir, 'log')
    check_dir(log_dir)
    save_dir = os.path.join(res_dir, 'saved')
    check_dir(save_dir)
    plot_dir = os.path.join(res_dir, 'plot')
    check_dir(plot_dir)
    best_checkpoint = os.path.join(res_dir, 'best_checkpoint')
    check_dir(best_checkpoint)
    interval_checkpoint = os.path.join(res_dir, 'intervel_checkponts')
    check_dir(interval_checkpoint)
    return model_dir, log_dir, save_dir,plot_dir,best_checkpoint,interval_checkpoint
