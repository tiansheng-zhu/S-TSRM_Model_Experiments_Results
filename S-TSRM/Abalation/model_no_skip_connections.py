...
class Thermohaline_Model(nn.Module):
    def __init__(self, in_shape, hid_S=16, hid_T=256, N_S=4,
        ...
        self.translator2 = nn.Sequential(
            nn.Conv2d(Depth_out1 * hid_S, 512, kernel_size=1, stride=1, padding=0),
        ...
        self.translator3 = nn.Sequential(
            nn.Conv2d( Depth_out2* hid_S, 512, kernel_size=1, stride=1, padding=0),
            nn.Conv2d(512, hid_T, kernel_size=1, stride=1, padding=0),
    ...
    def forward(self, x_raw):
        ...
        Y1 = self.dec1(Y1) # 1*d1,1,180,360
        ...
        concat2 = embed2.reshape(B, d1 * C_, H_, W_)  # 1,(10+d1)*64,90,180
        ...
        Y2 = self.dec2(Y2)  # 1*d2,1,180,360
        ...
        concat3 = embed3.reshape(B, d2 * C_, H_, W_)  # 1,(10+d2)*64,90,180
        ...
        Y3 = self.dec3(Y3)  # 1*d2,1,180,360
